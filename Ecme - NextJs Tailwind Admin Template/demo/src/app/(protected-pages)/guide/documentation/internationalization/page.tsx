                        ...
                        <SyntaxHighlighter language="json">{`// messages/es.json
{
    "title": "Inicio",
                    ...
                    <li>
                        ...
                        <SyntaxHighlighter language="tsx">{`// src/app/layout.tsx
...
...
export default function HomePage() {
    ...
    return <h1>{t('title')}</h1>;
            ...
            <div className="my-10" id="with-i18n-routing">
                ...
                <p>
                    If you&apos;re considering implementing i18n routing, refer to
                    the official next-intl documentation for a comprehensive
                    guide:{' '}
                    <a
                    ...
                    <SyntaxHighlighter language="json">{`// messages/fr.json
{
    "HomePage": {
        ...
        "about": "Aller à la page à propos"
                    ...
                    <SyntaxHighlighter language="ts">{`export const dateLocales: {
