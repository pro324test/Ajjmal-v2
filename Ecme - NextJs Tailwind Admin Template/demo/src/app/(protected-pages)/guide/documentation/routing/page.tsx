                ...
                <ol>
                    <li>
                        <p>
                            ...
                            <code>&apos;/articles&apos;</code>,
                            <code>&apos;/articles/[slug]&apos;</code>) serves as a{' '}
                            <strong>route matcher</strong> for the current URL.
                            When a user visits a page, the application matches
                            the URL against the route keys in the configuration.
                            Once a match is found, it retrieves the
                            corresponding route data from the configuration
                            object and applies the defined settings.
                        </p>
                        <p>For example:</p>
                        <ul>
                            <li>
                                <code>&apos;/articles&apos;</code> matches a static route.
                            </li>
                            <li>
                                <code>&apos;/articles/[slug]&apos;</code> matches a
                                dynamic route, where
