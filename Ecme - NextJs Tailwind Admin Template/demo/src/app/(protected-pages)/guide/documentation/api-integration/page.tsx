...
const Page = () => {
    return (
        <>
            ...
            <p>
                In this section, we&apos;ll explore how APIs work in Next.js, provide
                examples of creating API routes, and demonstrate how it work
                with Ecme.
            </p>
                ...
                <ol>
                    <li>
                        <p>
                            ...
                            (or folder structure) corresponds to the endpoint&apos;s
                            path.
                        </p>
                    </li>
                    <li>
            ...
            <div className="mt-10" id="creatingApiRoutes">
                ...
                <ol>
                    <li>
                        ...
                        <SyntaxHighlighter language="js">{`import { NextResponse } from 'next/server';
