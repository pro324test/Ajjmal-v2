...
GITHUB_AUTH_CLIENT_SECRET=your-github-secret`}</SyntaxHighlighter>
            ...
            <div className="mt-10" id="credentials">
                ...
                <SyntaxHighlighter language="ts">{`import type { NextAuthConfig } from "next-auth";
...
} satisfies NextAuthConfig;`}</SyntaxHighlighter>
            </div>
                ...
                <ol>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                Reset or delete
                                <i>(if you do not need routing protection)</i>{' '}
