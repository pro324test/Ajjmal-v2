    ...
    '/new-page': {
        ...
        meta: {
            ...
            <div className="mt-10" id="additional-note">
                ...
                <p>
                    Instead of applying <code>&apos;use client&apos;</code> directly to
                    the page file, it is recommended to create a separate client
                    component and import it into the page. This approach allows
                    the page itself to remain server-rendered, optimizing
                    server-side rendering (SSR) and letting only the client-side
                    logic be handled in the client component. For example:
                </p>
