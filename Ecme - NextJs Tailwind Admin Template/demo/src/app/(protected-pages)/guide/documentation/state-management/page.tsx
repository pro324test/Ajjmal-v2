...
const Page = () => {
    return (
        <>
            <p>
                In this template, we&apos;ve integrated Zustand for client side state
                management. Zustand is a small, fast, and scalable state
                management solution that allows you to manage state for your
                client-side components in a simple and efficient way.
            </p>
            <p>
                We use Zustand to manage some of the core states in the demo,
                but it&apos;s entirely optional for you to continue using it in your
                projects. If you prefer a different state management library or
                even the built-in React state, you can easily switch to what
