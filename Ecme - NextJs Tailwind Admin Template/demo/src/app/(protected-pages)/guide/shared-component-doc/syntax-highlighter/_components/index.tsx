...
const demoHeader = {
    ...
    desc: 'This component is a wrapper of <a class="underline text-primary" href="https://github.com/react-syntax-highlighter/react-syntax-highlighter" target="_blank">react-syntax-highlighter</a>.',
}
...
const reactSyntaxHighlighterApi = (
    <div className="demo-api-table mb-12">
        ...
        <p>
            All react-syntax-highlighter props can be applied on this component,
            refer{' '}
            <a
