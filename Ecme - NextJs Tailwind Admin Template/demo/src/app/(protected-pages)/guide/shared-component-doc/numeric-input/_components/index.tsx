...
const demos = [
    {
        ...
        mdPath: mdPath,
        title: 'Basic',
        desc: `Basic usage of FormNumericInput, all <a class="text-primary underline" href="https://s-yadav.github.io/react-number-format/docs/numeric_format" target="_blank">react-number-format props</a> can be apply to this component as well.`,
        component: <Basic />,
    },
    {
        mdName: 'WithForm',
